module.exports = [
"[project]/lib/aigc/acceptance-network-guard.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/autosave-coordinator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/bbox-references.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/connection-validation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAigcConnectionValidationError(connection, nodes, edges) {
    ...
    const sourcePort = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(sourceNode.type)?.outputs.find((port)=>port.id === sourceHandle);
    const targetPort = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(targetNode.type)?.inputs.find((port)=>port.id === targetHandle);
    ...
    if (targetNode.type === "video_generation" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$generation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isVideoPortActive"])(targetPort, targetNode.config.generation_mode)) {
        return "input_not_allowed_for_mode";
    }
    if (targetNode.type === "image_to_image" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedreamImageInputActive"])(targetNode, targetPort.id, edges)) {
        return "input_not_allowed_for_mode";
    }
    if (sourceNode.type === "image_to_image" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedreamImageOutputActive"])(sourceNode, sourcePort.id, edges)) {
        return "output_not_allowed_for_mode";
    }
    if (wouldCreateCycle(source, target, edges)) {
        return "cycle";
    }
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$bbox$2d$references$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["connectionBreaksBboxReferences"])({
        sourceNodeId: source,
        sourceHandle,
        targetNodeId: target,
        targetHandle
    ...
    const maxConnections = targetNode.type === "video_generation" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$generation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["videoInputLimit"])(targetNode, targetPort) : targetNode.type === "image_to_image" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageInputLimit"])(targetNode, targetPort) : targetPort.max_connections;
...
function connectionValidationFeedback(validationError, connection, nodes) {
    ...
    if (validationError === "target_connection_limit" && target?.type === "image_to_image" && connection.targetHandle === "image") {
        const registration = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(target.type);
        const port = registration?.inputs.find((candidate)=>candidate.id === connection.targetHandle);
        const limit = port ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageInputLimit"])(target, port) : 1;
        return (target.config.operation ?? "image_to_image") === "image_to_image" ? `图生图节点最多支持 ${limit} 张参考图` : `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageTitle"])(target)}节点最多支持 ${limit} 张图片`;
    }
    if (validationError === "target_connection_limit" && target?.type === "video_generation") {
        const port = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(target.type)?.inputs.find((candidate)=>candidate.id === connection.targetHandle);
        if (port) {
            return `${port.label}最多支持 ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$generation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["videoInputLimit"])(target, port)} 个连接`;
        }
    }
    ...
    if (validationError === "input_not_allowed_for_mode" && target?.type === "image_to_image") {
        const port = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(target.type)?.inputs.find((candidate)=>candidate.id === connection.targetHandle);
        return `${port?.label ?? "该输入"}不适用于${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageTitle"])(target)}模式`;
    }
...
"[project]/lib/aigc/definition-migration.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/download.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/aigc/definition-migration.ts [app-ssr] (ecmascript)");
...
function getAigcAssetDownload(asset, title, fallbackTitle, extension, omitFirstOrdinalSuffix, definition) {
    if (!asset?.available || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$asset$2d$display$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSafeAssetContentUrl"])(asset.download_url) || !asset.asset_id.trim()) {
        return null;
    }
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$asset$2d$display$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAssetDownloadUrlById"])(asset.asset_id, filename);
    if (!url) return null;
    return {
        filename,
        url
...
function currentGeneratedNodeName(asset, definition) {
    ...
    const migrated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcRunSnapshotV2"])(definition);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$display$2d$name$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deriveAigcNodeDisplayNames"])(migrated.nodes).get(nodeId)?.displayName ?? null;
}
...
"[project]/lib/aigc/editor-store.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/aigc/definition-migration.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/aigc/node-registry.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$multitrack$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/aigc/multitrack.ts [app-ssr] (ecmascript)");
...
function createAigcEditorStore(initialState = emptyInitialState) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStore"])((set, get)=>({
            ...
            resizeNode: (nodeId, size)=>{
                ...
                commit(set, get, {
                    definition: {
                        ...
                        nodes: state.definition.nodes.map((node)=>node.id === nodeId ? {
                                ...node,
                                size: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$layout$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeAigcNodeSize"])(node.type, size)
                            } : node)
                    }
                });
            },
                    ...
                    if (node.id === nodeId) {
                        return {
                            ...
                            config: imageAssetChanged && node.type === "image" ? {
                                ...
                                bbox: null,
                                bbox_asset_id: null
                            } : node.type === "image_to_image" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSeedreamImageConfig"])(config, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageOperation"])(node)) : node.type === "video_enhancement" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$enhancement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeVideoEnhancementConfig"])(config) : config
                        };
                    }
            ...
            setImageBboxBindings: (imageNodeId, bbox, textNodeIds, source)=>{
                ...
                const nodes = currentDefinition.nodes.map((node)=>{
                    ...
                    } else if (!existing && references.length < __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$bbox$2d$references$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIGC_MAX_BBOX_REFERENCES"]) {
                        nextReferences = [
                            ...references,
                            {
                                instruction: "",
            ...
            connect: (edge)=>{
                const state = get();
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$connection$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidAigcConnection"])({
...
function normalizeDefinition(definition) {
    const migrated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcDefinitionV2"])(definition);
    return {
        ...migrated,
        nodes: migrated.nodes.map((node)=>{
            const normalizedSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$layout$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeAigcNodeSize"])(node.type, node.size);
            if (node.type === "text") {
                return {
                    ...structuredClone(node),
                    size: normalizedSize,
            ...
            if (node.type === "image_to_image") {
                return {
                    ...structuredClone(node),
                    size: normalizedSize,
                    config: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSeedreamImageConfig"])(structuredClone(node.config))
                };
            }
            if (node.type === "text_to_image") {
                return {
                    ...
                    config: {
                        ...structuredClone(node.config),
                        size: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSeedreamImageSizeForStorage"])(node.config.size)
                    }
                };
            }
            if (node.type === "video_enhancement") {
                return {
                    ...structuredClone(node),
                    size: normalizedSize,
                    config: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$enhancement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeVideoEnhancementConfig"])(node.config)
                };
            }
            return {
                ...structuredClone(node),
...
function createNode(type, index, centerPosition) {
    ...
    const common = {
        id,
        custom_name: null,
        position: centerPosition ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$layout$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aigcNodePositionFromCenter"])(nodeType, centerPosition) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$layout$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aigcNodeInitialPosition"])(nodeType, index),
        size: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$layout$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aigcNodeDefaultSize"])(nodeType)
    };
    if (nodeType === "text") {
        return {
            ...common,
    ...
    if (nodeType === "llm") {
        return {
            ...
            type: nodeType,
            config: {
                model: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_DEFAULT_TEXT_MODEL"],
                system_prompt: "",
                temperature: 0.7
            }
        };
    ...
    if (nodeType === "video_generation") {
        return {
            ...common,
            type: nodeType,
            config: structuredClone(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_DEFAULT_VIDEO_CONFIG"])
        };
    }
    if (nodeType === "video_enhancement") {
        return {
            ...common,
            type: nodeType,
            config: structuredClone(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$enhancement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIGC_DEFAULT_VIDEO_ENHANCEMENT_CONFIG"])
        };
    }
    if (nodeType === "video_face_blur") {
        return {
            ...common,
            type: nodeType,
            config: structuredClone(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$video$2d$face$2d$blur$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIGC_DEFAULT_VIDEO_FACE_BLUR_CONFIG"])
        };
    }
    ...
    if (nodeType === "multi_track_edit") {
        return {
            ...common,
            type: nodeType,
            config: structuredClone(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$multitrack$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AIGC_DEFAULT_MULTI_TRACK_EDIT_CONFIG"])
        };
    }
    if (nodeType === "json_parser") {
        return {
            ...
            type: nodeType,
            config: {
                json_path: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_DEFAULT_JSON_PATH"]
            }
        };
    }
    ...
    return {
        ...
        type: nodeType,
        config: {
            model: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_DEFAULT_IMAGE_MODEL"],
            aspect_ratio: "1:1",
            size: "2K",
            format: "png",
            ...nodeType === "image_to_image" ? {
                operation: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_DEFAULT_IMAGE_OPERATION"]
            } : {}
        }
    };
}
...
function serializeAigcEditorDefinition(definition) {
    return structuredClone((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcDefinitionV2"])(definition));
}
function readAigcRunDefinitionSnapshot(definitionSnapshot) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcRunSnapshotV2"])(definitionSnapshot);
}
...
"[project]/lib/aigc/image-dimensions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/json-parser-ui.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/layers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/llm-image-input.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolveAigcLlmImageInput(definition, llmNodeId, runDetail) {
    ...
    const sourceLabel = source.custom_name?.trim() ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$display$2d$name$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deriveAigcNodeDisplayNames"])(definition.nodes).get(source.id)?.displayName ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$display$2d$name$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aigcNodeBaseDisplayName"])(source);
...
"[project]/lib/aigc/media-assets.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/media-validation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/modality-colors.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/multitrack-fonts.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/multitrack.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$multitrack$2d$fonts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/aigc/multitrack-fonts.ts [app-ssr] (ecmascript)");
;
...
function validateTextStyle(track, element, path, add) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$multitrack$2d$fonts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fontTypeIssue"])(element.style.font_type ?? null)) {
...
"[project]/lib/aigc/node-display-name.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function aigcNodeBaseDisplayName(node) {
    ...
    if (node.type === "image_to_image") {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$seedream$2d$image$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedreamImageTitle"])(node);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(node.type)?.label ?? node.type;
}
...
"[project]/lib/aigc/node-layout.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/node-registry.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
const AIGC_DEFAULT_VIDEO_CONFIG = {
    model: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_MODEL"],
    generation_mode: "text_to_video",
    task_type: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_TASK_TYPE"],
    resolution: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_RESOLUTION"],
    aspect_ratio: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_ASPECT_RATIO"],
    duration_seconds: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_DURATION_SECONDS"],
    generate_audio: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_GENERATE_AUDIO"]
};
;
;
;
...
const AIGC_MODEL_CONTROL_NODE_REGISTRY = [
    ...
    },
    {
        ...
        models: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_MODELS"]
    },
    {
...
"[project]/lib/aigc/prompt-optimization-context.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolvePromptOptimizationSourceImage(definition, targetNodeId, runDetail) {
    ...
    const source = definition.nodes.find((node)=>node.id === edge.sourceNodeId);
    const sourcePort = source ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(source.type)?.outputs.find((port)=>port.id === edge.sourceHandle) : null;
...
"[project]/lib/aigc/queries.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAigcRuns(pipelineId, initialData, enabled = true) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        refetchInterval: (query)=>query.state.data?.items.some((run)=>ACTIVE_RUN_STATUSES.has(run.status)) ? 2_000 : false
    });
}
async function fetchAllAigcRuns(pipelineId) {
    ...
    for(let page = 1;; page += 1){
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].listAigcRuns(pipelineId, {
            page,
...
function useAigcRunDetails(runs) {
    const queries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>runs.map((run)=>({
                queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getAigcRun(run.id),
                queryKey: aigcQueryKeys.run(run.id),
                refetchInterval: (query)=>aigcRunDetailPollingInterval(run, query.state.data),
                retry: false
            })), [
        runs
    ]);
    const combined = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueries"])({
        queries,
        combine: combineAigcRunDetails
    });
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            details: combined.details,
            states: new Map(runs.map((run, index)=>[
                    run.id,
...
function useAigcRun(runId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        enabled: runId !== null,
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getAigcRun(runId),
...
function useCreateAigcRun(pipelineId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (payload)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].createAigcRun(pipelineId, payload, globalThis.crypto.randomUUID()),
        onSuccess: (detail)=>{
...
function useRetryAigcNode(pipelineId) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueryClient"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: ({ nodeId, runId })=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].retryAigcRunNode(runId, nodeId, globalThis.crypto.randomUUID()),
        onSuccess: (detail)=>{
            queryClient.setQueryData(aigcQueryKeys.run(detail.run.id), detail);
            void queryClient.invalidateQueries({
                queryKey: aigcQueryKeys.runs(pipelineId)
...
function useCancelAigcRun(pipelineId) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueryClient"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (runId)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].cancelAigcRun(runId),
        onSuccess: (detail)=>{
            queryClient.setQueryData(aigcQueryKeys.run(detail.run.id), detail);
            void queryClient.invalidateQueries({
                queryKey: aigcQueryKeys.runs(pipelineId)
...
"[project]/lib/aigc/result-projection.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function projectAigcModalityRunResult(runDetail, nodeId) {
    const definition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcRunSnapshotV2"])(runDetail.run.definition_snapshot);
    const node = definition.nodes.find((candidate)=>candidate.id === nodeId);
...
function projectAigcVideoResult(definition, nodeId, assets) {
    const normalized = definition ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcRunSnapshotV2"])(definition) : undefined;
...
function isAigcVideoResult(definition, nodeId, asset) {
    const node = definition ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$definition$2d$migration$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["migrateAigcRunSnapshotV2"])(definition).nodes.find((candidate)=>candidate.id === nodeId) : undefined;
...
"[project]/lib/aigc/run-log.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/run-scope.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/seedream-image.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeSeedreamImageSizeForStorage(size) {
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$image$2d$dimensions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSeedreamImageSize"])(size);
    } catch  {
        return size;
    }
}
function normalizeSeedreamImageConfig(config, previousOperation) {
    ...
    if (operation === "layer_decomposition" && previousOperation !== undefined && previousOperation !== operation) {
        size = "auto";
    } else if (operation === "image_edit" && previousOperation !== undefined && previousOperation !== operation && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$image$2d$dimensions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedreamImagePresetSize"])(size)) {
        size = "2K";
...
function validateLayerDecompositionAssets(definition, nodeId, assets) {
    ...
    for (const asset of connectedAssets){
        const message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$media$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["layerDecompositionAssetError"])(asset);
        if (message) {
            return [
                {
...
function validateSeedreamImageNode(node, edges) {
    const registration = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get("image_to_image");
...
function validateSeedreamImageNodeSize(node) {
    ...
    if (node.type === "image_to_image") {
        const operation = seedreamImageOperation(node);
        if (operation === "image_to_image" && size === "auto" || operation === "image_edit" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$image$2d$dimensions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedreamImagePresetSize"])(size) || operation === "layer_decomposition" && size !== "auto" && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$image$2d$dimensions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedreamImagePresetSize"])(size)) {
            return issue("size_not_allowed_for_mode", `${seedreamImageTitle(node)}模式不支持尺寸 ${String(size)}`);
        }
    }
    if (size === "auto") return null;
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$image$2d$dimensions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSeedreamImageSize"])(size);
        return null;
    } catch (error) {
...
"[project]/lib/aigc/video-enhancement.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/video-face-blur.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/aigc/video-generation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isVideoEdgeIncompatible(edge, nodes) {
    ...
    const port = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get(target.type)?.inputs.find((candidate)=>candidate.id === edge.targetHandle);
...
function validateVideoGenerationAssets(definition, nodeId, assets) {
    ...
    const maximum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedanceInputDurationLimit"])(node.config.model);
    const videoMinimum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["seedanceVideoInputMinimum"])(node.config.model, node.config.task_type ?? "generate");
...
function validateVideoGenerationNode(node, edges) {
    const registration = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aigc$2f$node$2d$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AIGC_NODE_REGISTRY_BY_TYPE"].get("video_generation");
    if (!registration) return [];
    const counts = Object.fromEntries(registration.inputs.map((port)=>[
            port.id,
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSeedanceDurationValid"])(node.config.model, node.config.duration_seconds)) {
        return [
            issue("invalid_duration", "当前模型不支持所选视频时长")
        ];
    }
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_ASPECT_RATIOS"].includes(node.config.aspect_ratio)) {
        return [
    ...
    if (node.config.generation_mode === "multimodal_reference") {
        ...
        if (node.config.model !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seedance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SEEDANCE_DEFAULT_MODEL"] && counts.reference_audios > 0 && counts.reference_images + counts.reference_videos === 0) {
            return [
...
function isErrorCode(value) {
    return typeof value === "string" && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERROR_CODES"].includes(value);
}
...
"[project]/lib/asset-display.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAssetContentUrlById(assetId) {
    ...
    const baseUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBackendBaseUrl"])().replace(/\/+$/, "");
...
function getSafeMediaUrl(value, expectedApiSuffix) {
    ...
    if (value.startsWith("/api/assets/") && value.endsWith(expectedApiSuffix)) {
        return `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBackendBaseUrl"])().replace(/\/+$/, "")}${value}`;
    }
    try {
        const url = new URL(value);
...
"[project]/lib/layer-editor-geometry.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/seedance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=lib_1t4-zwt._.js.map