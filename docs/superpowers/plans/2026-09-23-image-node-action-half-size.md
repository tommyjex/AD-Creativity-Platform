...
- [x] **Step 1: Change local image action expectations**
...
- [x] **Step 2: Change projected image action expectations**
...
- [x] **Step 1: Halve the external container**
...
- [x] **Step 2: Halve the compact trigger**
...
- [x] **Step 3: Halve the compact icon**
...
- [x] **Step 1: Update computed CSS size assertions**
...
- [x] **Step 2: Run complete frontend checks**
...
- [x] **Step 3: Run three-viewport Playwright acceptance**
...
- [x] **Step 5: Record completion without committing product code**
